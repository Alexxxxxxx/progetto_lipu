        ...
        <div class="row">
            <div class="col-lg-12">
				<?php
					...
					{
						echo "<h1 class='page-header'>Ricerca Scheda</h1>";
					}
				?>
            </div>
            <!-- /.col-lg-12 -->
                ...
                <div class="panel panel-default">
					...
					<div id="tab-section">
						<div id="tab-header">
							...
							<div align="right">
								<a href="" class='btn btn-success stampa'><i class="fa fa-print fa-fw"></i></a>
								<a <?php echo "href='cartella_clinica.php?id_ricovero=$id_ricovero'"; ?> class='btn btn-success cartella'>
									<i class="fa fa-folder-open fa-fw"></i>
								</a>
								<a target="_blank" href="esporta_pdf.php" class='btn btn-success download'><i class="fa fa-file-pdf-o fa-fw"></i></a>
							</div>
						</div>
						<br>
						<div id="tab-body">
					...
					<?php
						...
						{
							echo "<form action='apri_scheda.php' method='GET'>";
							echo "<div class='form-group'>";
							echo "<label>Inserisci ID ricovero</label>";
							echo "<input name='id_ricovero' type='text' class='form-control'>";
							echo "</div>";
							echo "<div class='form-group'>";
							echo "<a href='apri_scheda.php' class='btn btn-warning'>Cancel</a>		";
							echo "<input name='btn' value='Save' type='submit' class='btn btn-success'>";
							echo "</div>";
							echo "</form>";
						}
					?>
