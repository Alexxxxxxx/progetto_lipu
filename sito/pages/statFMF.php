<?php
	...
	if(!$_POST){
		getHeaderHTML("ITIS","Statistics - FULL",$dblipu);
	?>

	<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Statistics - FULL</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                    		<form action="<?php echo "statFMF.php"; ?>" method="POST" onsubmit="return del();">
								<div class="text-right">
									<a href="">
										<img src="<?php echo $pathImgPg.'excel.png';?>" title="Export Table" alt="Excel" onclick="exportExcel('dataTables-example', '<?php echo $_SESSION['DB_lipu'] ?>-StatisticsFMF')">
									</a>
									<!-- <button class="btn btn-default" onclick="exportExcel('dataTables-example', '<?php echo $_SESSION['DB_lipu'] ?>-StatisticsFMF')">Export table</button> -->
								</div>
