<?php
	...
	getHeaderHTML("ITIS","PDF Permessi Uscita",$dblipu);
?>

	<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> PDF PERMESSI USCITA</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
			                                ...
			                                <?php
												...
												if($result!=NULL){
													while($row = $result->fetch_array()){
														...
														echo "<td><a href=\"permessiuscita.php?canc=$row[numero]\" ><img src=\"".$pathImgPg.'delmov.png'."\" title=\"Elimina Permesso\" align=\"center\" width=\"20\"></a></td>";														
														echo "</tr>";
														}
													}
												?>
